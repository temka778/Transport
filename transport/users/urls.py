...
from .views import SignUp, Profile, signup_done, ProfileUpdateView, CustomLoginView, CustomPasswordResetView
...
urlpatterns = [
    ...
    path("password_reset/", CustomPasswordResetView.as_view(template_name='users/password_reset_form.html'), name="password_reset"),
